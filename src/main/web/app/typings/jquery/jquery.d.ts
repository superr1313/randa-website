...
interface JQueryAjaxSettings {
    ...
    crossDomain?: boolean;
    /**
     * Data to be sent to the randa_website. It is converted to a query string, if not already a string. It's appended to the url for GET-requests. See processData option to prevent this automatic processing. Object must be Key/Value pairs. If value is an Array, jQuery serializes multiple values with same key based on the value of the traditional setting (described below).
     */
    data?: any;
    /**
    ...
    /**
     * The type of data that you're expecting back from the randa_website. If none is specified, jQuery will try to infer it based on the MIME type of the response (an XML MIME type will yield XML, in 1.4 JSON will yield a JavaScript object, in 1.4 script will execute the script, and anything else will be returned as a string).
     */
    dataType?: string;
    /**
    ...
    isLocal?: boolean;
    /**
     * Override the callback function name in a jsonp request. This value will be used instead of 'callback' in the 'callback=?' part of the query string in the url. So {jsonp:'onJSONPLoad'} would result in 'onJSONPLoad=?' passed to the randa_website. As of jQuery 1.5, setting the jsonp option to false prevents jQuery from adding the "?callback" string to the URL or attempting to use "=?" for transformation. In this case, you should also explicitly set the jsonpCallback setting. For example, { jsonp: false, jsonpCallback: "callbackName" }
     */
    jsonp?: any;
    /**
...
interface JQueryStatic {
     ...
     * @param dataType The type of data expected from the randa_website. Default: Intelligent Guess (xml, json, script, or html).
     */
     ...
     * @param dataType The type of data expected from the randa_website. Default: Intelligent Guess (xml, json, script, text, html).
     */
